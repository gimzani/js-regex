...
<h2 id="Character_classes">
  <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Cheatsheet" target="_blank">Character classes</a>
</h2>
...
<table class="table">
 ...
 <tbody>
  ...
  <tr>
   <td><code>[\b]</code></td>
   <td>Matches a backspace. If you're looking for the word-boundary character (<code>\b</code>), see <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Boundaries" target="_blank">Boundaries</a>.</td>
  </tr>
  <tr>
   <td><code>\0</code></td>
  ...
  <tr>
   ...
   <td>
    <p>Matches a control character using <a class="external" href="https://en.wikipedia.org/wiki/Caret_notation" rel="noopener" target="_blank">caret notation</a>, where "X" is a letter from A–Z (corresponding to codepoints <code>U+0001</code><em>–</em><code>U+001F</code>). For example, <code>/\cM/</code> matches "\r" in "\r\n".</p>
   </td>
  </tr>
  <tr>
...
<h2 id="Assertions"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Assertions" target="_blank">Assertions</a></h2>
 ...
 <tbody>
  <tr>
   ...
   <td>
    ...
    <div class="blockIndicator note">
    <p>This character has a different meaning when it appears at the start of a <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Groups_and_Ranges" target="_blank">group</a>.</p>
    </div>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    ...
    <p>To match a backspace character (<code>[\b]</code>), see <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Character_Classes" target="_blank">Character Classes</a>.</p>
   </td>
  </tr>
  <tr>
   <td><code>\B</code></td>
...
<table class="table">
 ...
 <tbody>
  ...
  <tr>
   <td><code>x(?!y)</code></td>
   <td>
    <p><strong>Negative lookahead assertion: </strong>Matches "x" only if "x"<span style="font-size: 1rem; letter-spacing: -0.00278rem;"> is not followed by </span>"y"<span style="font-size: 1rem; letter-spacing: -0.00278rem;">.</span> For example, <code style="font-size: 1rem; letter-spacing: -0.00278rem;">/\d+(?!\.)/</code><span style="font-size: 1rem; letter-spacing: -0.00278rem;"> matches a number only if it is not followed by a decimal point. </span><code>/\d+(?!\.)/.exec('3.141')</code> matches "141" but not "3.</p>
   </td>
  </tr>
  <tr>
   <td><code>(?&lt;=y)x</code></td>
   <td>
    <p><strong>Lookbehind assertion: </strong>Matches "x" only if "x" is preceded by "y". For example, <code style="font-size: 1rem; letter-spacing: -0.00278rem;">/(?&lt;=Jack)Sprat/</code><span style="font-size: 1rem; letter-spacing: -0.00278rem;"> matches "Sprat" only if it is preceded by "Jack". </span><code>/(?&lt;=Jack|Tom)Sprat/</code> matches "Sprat" only if it is preceded by "Jack" or "Tom". However, neither "Jack" nor "Tom" is part of the match results.</p>
   </td>
  </tr>
  <tr>
   <td><code>(?&lt;!y)x</code></td>
   <td>
    <p><strong>Negative lookbehind assertion: </strong>Matches "x" only if "x" is not preceded by "y". For example, <code style="font-size: 1rem; letter-spacing: -0.00278rem;">/(?&lt;!-)\d+/</code><span style="font-size: 1rem; letter-spacing: -0.00278rem;"> matches a number only if it is not preceded by a minus sign. </span><code>/(?&lt;!-)\d+/.exec('3')</code> matches "3". <code>/(?&lt;!-)\d+/.exec('-3')</code>  match is not found because the number is preceded by the minus sign.</p>
   </td>
  </tr>
 </tbody>
</table>

<h2 id="Groups_and_ranges"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Groups_and_Ranges" target="_blank">Groups and ranges</a></h2>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <div class="blockIndicator note">
    <p>The ^ character may also indicate the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Boundaries" target="_blank">beginning of input</a>.</p>
    </div>
   </td>
  </tr>
  <tr>
   ...
   <td>
    ...
    <p><code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/match" target="_blank">String.match()</a></code> won't return groups if the <code>/.../g</code> flag is set. However, you can still use <code><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/matchAll">String.matchAll()</a></code> to get all matches.</p>
   </td>
  </tr>
  <tr>
...
<h2 id="Quantifiers"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Quantifiers" target="_blank">Quantifiers</a></h2>
...
<h2 id="Unicode_property_escapes"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Unicode_Property_Escapes" target="_blank">Unicode property escapes</a></h2>
...
<dl>
 ...
 <dd>The name of a <a class="external" href="https://tc39.es/ecma262/#table-binary-unicode-properties" rel="noopener" target="_blank">binary property</a>.</dd>
 <dt>UnicodePropertyName</dt>
 <dd>The name of a non-binary property: <code>General_Category</code> (<code>gc</code>), <code>Script</code> (<code>sc</code>), or  <code>Script_Extensions</code> (<code>scx</code>).</dd>
